...
#SBATCH --job-name=gpt2_large_ecg       # 作业名称
#SBATCH --account=PAS2473		    # Project ID
#SBATCH --output=/users/PAS2473/brucewan666/ECG/ECG/output_logs/gpt2_large_ecg.log        # 输出日志文件
#SBATCH --error=/users/PAS2473/brucewan666/ECG/ECG/output_logs/gpt2_large_ecg_error.log         # 错误日志文件
#SBATCH --nodes=1                   # 节点数
...
# Lora training
accelerate launch --main_process_port 31228 \
