...
# #SBATCH --job-name=llama_1_ecg       # 作业名称
# #SBATCH --account=PAS2473		    # Project ID
# #SBATCH --output=/users/PAS2473/brucewan666/ECG/ECG/output_logs/llama_1_ecg.log        # 输出日志文件
# #SBATCH --error=/users/PAS2473/brucewan666/ECG/ECG/output_logs/llama_1_ecg_error.log         # 错误日志文件
# #SBATCH --nodes=1                   # 节点数
...
accelerate launch --main_process_port 31226 \
    ...
    --weight_decay 0. \
    --num_train_epochs 5 \
    --output_dir /fs/scratch/PAS2473/zhongwei_save_ckpt/llama1_lora_ckpt \
    --with_tracking \
